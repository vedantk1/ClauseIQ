...
from main import DocumentStorage


class TestDocumentStorage:
    """Test document storage functionality with MongoDB."""

    def setup_method(self):
        """Set up test with mocked MongoDB."""
        # Mock the mongo_storage object
        self.mock_mongo_storage = Mock()
        
    def test_save_and_get_document(self):
        """Test saving and retrieving a document."""
        with patch('main.get_mongo_storage', return_value=self.mock_mongo_storage):
            ...
            # Save the document
            doc_id = DocumentStorage.save_document(document)
            ...
            retrieved_doc = DocumentStorage.get_document("test-123")
    ...
    def test_get_nonexistent_document(self):
        ...
        with patch('main.get_mongo_storage', return_value=self.mock_mongo_storage):
            ...
            result = DocumentStorage.get_document("nonexistent")
    ...
    def test_get_all_documents_with_data(self):
        ...
        with patch('main.get_mongo_storage', return_value=self.mock_mongo_storage):
            ...
            DocumentStorage.save_document(doc1)
            
            self.mock_mongo_storage.save_document.return_value = "doc2"
            DocumentStorage.save_document(doc2)
