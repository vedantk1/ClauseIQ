  ...
  return (
    <div className="min-h-screen bg-bg-primary flex">
      ...
      <div className="flex-1 flex">
        {/* ReviewSidebar - Always visible vertical navigation */}
        <ReviewSidebar
        ...
        {/* Main Document Area - Always visible PDF viewer */}
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
          <div>
            ...
            <div className="flex items-center gap-3">
              <span
                className="text-text-secondary hover:text-accent-blue cursor-pointer transition-colors flex items-center gap-1"
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value="summary">
            ...
            >
              <div
                className={`space-y-6 ${
                  isDocumentViewerOpen ? "lg:col-span-1" : "lg:col-span-2"
                }`}
              >
                {/* Analysis Content */}
                ...
                {/* Enhanced Sidebar - show inline when PDF is open */}
                {(!isDocumentViewerOpen ||
              ...
              {/* Original Enhanced Sidebar - when PDF is closed */}
              {!isDocumentViewerOpen && (
                <div className="space-y-6">
                  {/* Enhanced Document Insights Component */}
                  <DocumentInsights
