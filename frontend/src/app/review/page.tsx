                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex gap-2">
                        <select
                          ...
                          className="flex-1 px-3 py-1 text-sm bg-bg-elevated border border-border-muted rounded-md text-text-primary focus:ring-2 focus:ring-accent-purple focus:border-transparent"
                        >
              ...
              <Card>
                ...
                {selectedClause ? (
                  <div className="space-y-6">
                    ...
                    {/* User Notes Display - Enhanced UI */}
                          ...
                          {getAllNotes(selectedClause.id)
                            ...
                            .map((note, index) => {
                              ...
                              return (
                                <div
                                  key={note.id}
                                  className="border border-border-muted rounded-lg p-3 bg-white shadow-sm hover:shadow-md transition-shadow"
                                >
                                  {/* Note Header */}
                                  <div className="flex items-start justify-between mb-2">
                                    <div className="flex items-center gap-2">
                                  ...
                                  {/* Note Content */}
                                  <div className="bg-bg-elevated rounded p-2 border-l-4 border-accent-blue">
