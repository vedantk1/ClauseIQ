      ...
      <div className="flex-1 flex">
        ...
        <div className="flex-1 flex min-w-0">
          ...
          <div className="flex-1 flex flex-col min-w-0">
            {/* Compact Header */}
            <div className="border-b border-border-light bg-bg-primary px-6 py-2">
              <div className="flex justify-end items-center">
                <div className="flex items-center gap-3">
                  ...
                  <DropdownMenu
                    align="right"
                    trigger={
                      <div className="relative inline-flex items-center justify-center font-medium rounded-md transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-purple focus-visible:ring-offset-2 bg-bg-surface text-text-primary hover:bg-bg-elevated border border-border-light h-9 w-9 cursor-pointer">
                        <svg
                          className="w-4 h-4"
                          fill="none"
                          stroke="currentColor"
