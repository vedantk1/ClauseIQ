...
import { highlightLegalTokens, highlightTextWithTokensAndSearch } from "@/components/review/clauseUtils";
      ...
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-600 mb-6">
            This demo showcases automatic highlighting of critical legal tokens including:
            <strong> money amounts, time periods, percentages, and deadlines</strong>.
            The highlighting works in combination with search functionality.
          </p>
          
          <div className="mb-6">
            <label className="block text-sm font-medium text-gray-700 mb-2">
              Search (try "30", "salary", or "$120")
            </label>
            <input
              type="text"
              value={searchQuery}
        ...
        <div className="grid gap-6">
          {TEST_CLAUSES.map((clause) => (
            <div key={clause.id} className="bg-white rounded-lg shadow-md p-6 border">
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-gray-500">
            This enhanced highlighting improves legal document review speed by automatically identifying critical terms.
          </p>
        </div>
      </div>
    </div>
