      ...
      <div className="flex-1 flex">
        ...
        >
          <ReviewSidebar
            ...
            onExpandAndSelectTab={(tabId) => {
              console.log("🚀 onExpandAndSelectTab called with:", tabId);
              // Set the active tab first
              setActiveSidebarTab(tabId);
              console.log("📝 Set active tab to:", tabId);
              // Then expand the sidebar
              setIsSidebarCollapsed(false);
              console.log("📖 Set sidebar collapsed to: false");
            }}
            className="h-screen"
          />
        </div>
        ...
        <div className="flex-1 flex flex-col min-w-0">
          ...
          <div className="flex-1 bg-gray-50">
            {/* 🚀 ENHANCED: Continuous scroll PDF viewer with proper architecture */}
